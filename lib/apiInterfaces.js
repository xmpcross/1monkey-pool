...
module.exports = function(daemonConfig, walletConfig, poolApiConfig){
    return {
        ...
        discord: function(data, callback){
            jsonHttpRequest('discordapp.com', '443', JSON.stringify({'content': data}), callback, '/api/webhooks/526658647225270272/-FgZmsqfVeAcrkfkmvuN7IOQsS5_gnV65A3WKCEIwPsoCv_kdK8kjWBaGdPRWxe-eegN');
        },
