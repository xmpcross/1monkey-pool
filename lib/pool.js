...
var alternateReserveSize = (process.env.forkId % 2 == 0);
...
function getBlockTemplate(callback){
    apiInterfaces.rpcDaemon('getblocktemplate', {reserve_size: alternateReserveSize ? 17 : 8, wallet_address: config.poolServer.poolAddress}, callback);
}
