...
var defaultReserveSize = forkId % 2 == 0 ? 17 : 19;
...
var commonNonce_17 = config.poolServer.commonNonce_17 || '0037A582';
var highestShare = 0;
...
function setNonceOffSet(r) {
    switch (r) {
        ...
        default:
            ...
            commonNonce = [[4, new Buffer(commonNonce_17, 'hex'), 4]], extraNonceMultiplier = (forkId - 1) * (16 / numForks), maxExtraNonce = 4095;
