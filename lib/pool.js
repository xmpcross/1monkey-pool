...
var enableExtraRandomBytes = false;
...
function setNonceOffSet(r) {
    switch (r) {
        ...
        case 17:
        default:
            instanceIdOffset = 0, extraNonceOffset = 0, poolNonceOffset = 8, workerNonceOffset = 12, extraRandomOffset = 9;
            commonNonce = [[4, Buffer.from(commonNonce_17, 'hex'), 3]], extraNonceMultiplier = forkId - 1;
...
function BlockTemplate(template){
    ...
    this.MAX_EXTRA_NONCE = maxExtraNonce || 65535;
