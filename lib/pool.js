...
var poolWalletAddress = rotatingWallet ? getRotatingPoolWalletAddress() : config.poolServer.poolAddress;
var nextPoolWalletAddress;
...
function getBlockTemplate(callback){
    apiInterfaces.rpcDaemon('getblocktemplate', {reserve_size: alternateReserveSize ? 17 : 8, wallet_address: poolWalletAddress}, callback);
}
...
function processBlockTemplate(template){
    if (rotatingWallet && nextPoolWalletAddress) {
        poolWalletAddress = nextPoolWalletAddress;
        nextPoolWalletAddress = null;
    }
