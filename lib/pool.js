...
var maxRotateWalletEffort = (typeof config.poolServer.rotateWalletEffort == 'number') ? config.poolServer.rotateWalletEffort : 40;
var roundHashes = 0;
...
function getBlockTemplate(callback){
    apiInterfaces.rpcDaemon('getblocktemplate', {reserve_size: 17, wallet_address: nextPoolWalletAddress}, callback);
}
...
function recordShareData(miner, job, shareDiff, blockCandidate, hashHex, shareType, blockTemplate){
    ...
    redisClient.multi(redisCommands).exec(function(err, replies){
        ...
        if (blockCandidate){
            ...
            var totalShares = roundHashes = Object.keys(workerShares).reduce(function(p, c){
...
function handleBlockFound(blockHash, submitDiff, blockHeight, blockDiff, minerAddr, walletAddr) {
    if (hasWalletPool && (roundHashes < blockDiff * maxRotateWalletEffort * 0.01)) {
