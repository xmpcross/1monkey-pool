...
var commonNonce_17 = global.globalShareBlockTemplate ? default_commonNonce_17 : (cnAlgo == 'randomx' ? '1C3FA722' : threadNonce);
...
function setNonceOffSet(r, customOffset) {
    ...
    switch (r) {
        ...
        case 13:
            ...
            break;
        case 27:
            extraNonceOffset = 15, poolNonceOffset = 19, workerNonceOffset = 23;
            commonNonce = [[0, Buffer.from(commonNonce_27, 'hex'), 11], [11, Buffer.from(threadNonce, 'hex'), 2], [13, Buffer.from('43', 'hex'), 2]], extraNonceMultiplier = null;
