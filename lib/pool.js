...
function setNonceOffSet(r) {
    switch (r) {
        ...
        case 16:
            ...
            commonNonce = [[1,  Buffer.from(commonNonce_16_1, 'hex'), 4], [5,  Buffer.from(forkId.toString(16).padStart(8, '0'), 'hex'), 4], [12, Buffer.from(commonNonce_16_2, 'hex'), 4]],
        ...
        default:
            ...
            commonNonce = [[4, Buffer.from(commonNonce_17, 'hex'), 4]], extraNonceMultiplier = (forkId - 1) * (2 / numForks), maxExtraNonce = 4095;
