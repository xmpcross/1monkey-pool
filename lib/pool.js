...
/* Dynamic Vardiff */
config.poolServer.varDiff.forced = 'off';
redisClient.hmset(config.coin + ':vardiff', 'maxDiff', config.poolServer.varDiff.maxDiff, 'targetTime', config.poolServer.varDiff.targetTime, 'forced', 'off');
