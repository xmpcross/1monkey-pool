...
function setNonceOffSet(r) {
    switch (r) {
        ...
        case 17:
        default:
            instanceIdOffset = 0, extraNonceOffset = 4, poolNonceOffset = 8, workerNonceOffset = 12, extraRandomOffset = 0;
            commonNonce = [[0, Buffer.from(commonNonce_17, 'hex'), 4]], extraNonceMultiplier = (global.globalShareBlockTemplate ? forkId - 1 : null);
